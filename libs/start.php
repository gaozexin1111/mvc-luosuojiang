...
//bootstrap地址
define("BOOT_ADD",CSS_ADD."admin".DIRECTORY_SEPARATOR."bootstrap.css");
//js地址
define("JS_ADD",STATIC_ADD."js".DIRECTORY_SEPARATOR);
//font的地址
define("FONT_ADD",STATIC_ADD."font".DIRECTORY_SEPARATOR);
define("IMAGE_ADD",STATIC_ADD."image".DIRECTORY_SEPARATOR);
...
include_once LIBS_PATH."smarty/libs/Smarty.class.php";
